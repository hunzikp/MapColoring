...
```{r chessplot, fig.cap = "Chess board with optimal contrast coloring.", message=FALSE, warning=FALSE}
...
```{r worldplot, fig.cap = "Political world map with optimal contrast coloring.", message=FALSE, warning=FALSE}
